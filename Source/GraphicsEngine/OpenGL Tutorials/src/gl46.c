...
static void  GL_APIENTRY _impl_glGetnConvolutionFilter (GLenum target, GLenum format, GLenum type, GLsizei bufSize, void * image) {
  _glptr_glGetnConvolutionFilter = (PFN_glGetnConvolutionFilter)GalogenGetProcAddress("glGetnConvolutionFilter");
   _glptr_glGetnConvolutionFilter(target, format, type, bufSize, image);
}
PFN_glGetnConvolutionFilter _glptr_glGetnConvolutionFilter = _impl_glGetnConvolutionFilter;
...
static void  GL_APIENTRY _impl_glMultiTexCoordP2ui (GLenum texture, GLenum type, GLuint coords) {
  _glptr_glMultiTexCoordP2ui = (PFN_glMultiTexCoordP2ui)GalogenGetProcAddress("glMultiTexCoordP2ui");
   _glptr_glMultiTexCoordP2ui(texture, type, coords);
}
PFN_glMultiTexCoordP2ui _glptr_glMultiTexCoordP2ui = _impl_glMultiTexCoordP2ui;
...
static void  GL_APIENTRY _impl_glMultiTexCoordP4uiv (GLenum texture, GLenum type, const GLuint * coords) {
  _glptr_glMultiTexCoordP4uiv = (PFN_glMultiTexCoordP4uiv)GalogenGetProcAddress("glMultiTexCoordP4uiv");
   _glptr_glMultiTexCoordP4uiv(texture, type, coords);
}
PFN_glMultiTexCoordP4uiv _glptr_glMultiTexCoordP4uiv = _impl_glMultiTexCoordP4uiv;
...
static void  GL_APIENTRY _impl_glVertexP2ui (GLenum type, GLuint value) {
  _glptr_glVertexP2ui = (PFN_glVertexP2ui)GalogenGetProcAddress("glVertexP2ui");
   _glptr_glVertexP2ui(type, value);
}
PFN_glVertexP2ui _glptr_glVertexP2ui = _impl_glVertexP2ui;
...
static void  GL_APIENTRY _impl_glGetnMapfv (GLenum target, GLenum query, GLsizei bufSize, GLfloat * v) {
  _glptr_glGetnMapfv = (PFN_glGetnMapfv)GalogenGetProcAddress("glGetnMapfv");
   _glptr_glGetnMapfv(target, query, bufSize, v);
}
PFN_glGetnMapfv _glptr_glGetnMapfv = _impl_glGetnMapfv;
...
static void  GL_APIENTRY _impl_glGetProgramResourceiv (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum * props, GLsizei count, GLsizei * length, GLint * params) {
  _glptr_glGetProgramResourceiv = (PFN_glGetProgramResourceiv)GalogenGetProcAddress("glGetProgramResourceiv");
   _glptr_glGetProgramResourceiv(program, programInterface, index, propCount, props, count, length, params);
}
...
static void  GL_APIENTRY _impl_glMultiTexCoordP2uiv (GLenum texture, GLenum type, const GLuint * coords) {
  _glptr_glMultiTexCoordP2uiv = (PFN_glMultiTexCoordP2uiv)GalogenGetProcAddress("glMultiTexCoordP2uiv");
   _glptr_glMultiTexCoordP2uiv(texture, type, coords);
}
PFN_glMultiTexCoordP2uiv _glptr_glMultiTexCoordP2uiv = _impl_glMultiTexCoordP2uiv;
...
static void  GL_APIENTRY _impl_glGetInternalformati64v (GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint64 * params) {
  _glptr_glGetInternalformati64v = (PFN_glGetInternalformati64v)GalogenGetProcAddress("glGetInternalformati64v");
   _glptr_glGetInternalformati64v(target, internalformat, pname, count, params);
}
...
static void  GL_APIENTRY _impl_glMultiTexCoordP1uiv (GLenum texture, GLenum type, const GLuint * coords) {
  _glptr_glMultiTexCoordP1uiv = (PFN_glMultiTexCoordP1uiv)GalogenGetProcAddress("glMultiTexCoordP1uiv");
   _glptr_glMultiTexCoordP1uiv(texture, type, coords);
}
PFN_glMultiTexCoordP1uiv _glptr_glMultiTexCoordP1uiv = _impl_glMultiTexCoordP1uiv;
...
static void  GL_APIENTRY _impl_glColorP3ui (GLenum type, GLuint color) {
  _glptr_glColorP3ui = (PFN_glColorP3ui)GalogenGetProcAddress("glColorP3ui");
   _glptr_glColorP3ui(type, color);
}
PFN_glColorP3ui _glptr_glColorP3ui = _impl_glColorP3ui;
...
static void  GL_APIENTRY _impl_glGetnMapiv (GLenum target, GLenum query, GLsizei bufSize, GLint * v) {
  _glptr_glGetnMapiv = (PFN_glGetnMapiv)GalogenGetProcAddress("glGetnMapiv");
   _glptr_glGetnMapiv(target, query, bufSize, v);
}
PFN_glGetnMapiv _glptr_glGetnMapiv = _impl_glGetnMapiv;
...
static void  GL_APIENTRY _impl_glTexCoordP3ui (GLenum type, GLuint coords) {
  _glptr_glTexCoordP3ui = (PFN_glTexCoordP3ui)GalogenGetProcAddress("glTexCoordP3ui");
   _glptr_glTexCoordP3ui(type, coords);
}
PFN_glTexCoordP3ui _glptr_glTexCoordP3ui = _impl_glTexCoordP3ui;
...
static void  GL_APIENTRY _impl_glTexCoordP3uiv (GLenum type, const GLuint * coords) {
  _glptr_glTexCoordP3uiv = (PFN_glTexCoordP3uiv)GalogenGetProcAddress("glTexCoordP3uiv");
   _glptr_glTexCoordP3uiv(type, coords);
}
PFN_glTexCoordP3uiv _glptr_glTexCoordP3uiv = _impl_glTexCoordP3uiv;
...
static void  GL_APIENTRY _impl_glGetSynciv (GLsync sync, GLenum pname, GLsizei count, GLsizei * length, GLint * values) {
  _glptr_glGetSynciv = (PFN_glGetSynciv)GalogenGetProcAddress("glGetSynciv");
   _glptr_glGetSynciv(sync, pname, count, length, values);
}
...
static void  GL_APIENTRY _impl_glVertexP2uiv (GLenum type, const GLuint * value) {
  _glptr_glVertexP2uiv = (PFN_glVertexP2uiv)GalogenGetProcAddress("glVertexP2uiv");
   _glptr_glVertexP2uiv(type, value);
}
PFN_glVertexP2uiv _glptr_glVertexP2uiv = _impl_glVertexP2uiv;

static void  GL_APIENTRY _impl_glVertexP3uiv (GLenum type, const GLuint * value) {
  _glptr_glVertexP3uiv = (PFN_glVertexP3uiv)GalogenGetProcAddress("glVertexP3uiv");
   _glptr_glVertexP3uiv(type, value);
}
PFN_glVertexP3uiv _glptr_glVertexP3uiv = _impl_glVertexP3uiv;
...
static void  GL_APIENTRY _impl_glTexCoordP2ui (GLenum type, GLuint coords) {
  _glptr_glTexCoordP2ui = (PFN_glTexCoordP2ui)GalogenGetProcAddress("glTexCoordP2ui");
   _glptr_glTexCoordP2ui(type, coords);
}
PFN_glTexCoordP2ui _glptr_glTexCoordP2ui = _impl_glTexCoordP2ui;
...
static void  GL_APIENTRY _impl_glMultiTexCoordP3uiv (GLenum texture, GLenum type, const GLuint * coords) {
  _glptr_glMultiTexCoordP3uiv = (PFN_glMultiTexCoordP3uiv)GalogenGetProcAddress("glMultiTexCoordP3uiv");
   _glptr_glMultiTexCoordP3uiv(texture, type, coords);
}
PFN_glMultiTexCoordP3uiv _glptr_glMultiTexCoordP3uiv = _impl_glMultiTexCoordP3uiv;

static void  GL_APIENTRY _impl_glMultiTexCoordP4ui (GLenum texture, GLenum type, GLuint coords) {
  _glptr_glMultiTexCoordP4ui = (PFN_glMultiTexCoordP4ui)GalogenGetProcAddress("glMultiTexCoordP4ui");
   _glptr_glMultiTexCoordP4ui(texture, type, coords);
}
PFN_glMultiTexCoordP4ui _glptr_glMultiTexCoordP4ui = _impl_glMultiTexCoordP4ui;

static void  GL_APIENTRY _impl_glNormalP3ui (GLenum type, GLuint coords) {
  _glptr_glNormalP3ui = (PFN_glNormalP3ui)GalogenGetProcAddress("glNormalP3ui");
   _glptr_glNormalP3ui(type, coords);
}
PFN_glNormalP3ui _glptr_glNormalP3ui = _impl_glNormalP3ui;
...
static void  GL_APIENTRY _impl_glGetInternalformativ (GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint * params) {
  _glptr_glGetInternalformativ = (PFN_glGetInternalformativ)GalogenGetProcAddress("glGetInternalformativ");
   _glptr_glGetInternalformativ(target, internalformat, pname, count, params);
}
...
static void  GL_APIENTRY _impl_glGetnMapdv (GLenum target, GLenum query, GLsizei bufSize, GLdouble * v) {
  _glptr_glGetnMapdv = (PFN_glGetnMapdv)GalogenGetProcAddress("glGetnMapdv");
   _glptr_glGetnMapdv(target, query, bufSize, v);
}
PFN_glGetnMapdv _glptr_glGetnMapdv = _impl_glGetnMapdv;

static void  GL_APIENTRY _impl_glGetnPixelMapfv (GLenum map, GLsizei bufSize, GLfloat * values) {
  _glptr_glGetnPixelMapfv = (PFN_glGetnPixelMapfv)GalogenGetProcAddress("glGetnPixelMapfv");
   _glptr_glGetnPixelMapfv(map, bufSize, values);
}
PFN_glGetnPixelMapfv _glptr_glGetnPixelMapfv = _impl_glGetnPixelMapfv;

static void  GL_APIENTRY _impl_glGetnPixelMapuiv (GLenum map, GLsizei bufSize, GLuint * values) {
  _glptr_glGetnPixelMapuiv = (PFN_glGetnPixelMapuiv)GalogenGetProcAddress("glGetnPixelMapuiv");
   _glptr_glGetnPixelMapuiv(map, bufSize, values);
}
PFN_glGetnPixelMapuiv _glptr_glGetnPixelMapuiv = _impl_glGetnPixelMapuiv;

static void  GL_APIENTRY _impl_glGetnPixelMapusv (GLenum map, GLsizei bufSize, GLushort * values) {
  _glptr_glGetnPixelMapusv = (PFN_glGetnPixelMapusv)GalogenGetProcAddress("glGetnPixelMapusv");
   _glptr_glGetnPixelMapusv(map, bufSize, values);
}
PFN_glGetnPixelMapusv _glptr_glGetnPixelMapusv = _impl_glGetnPixelMapusv;

static void  GL_APIENTRY _impl_glGetnPolygonStipple (GLsizei bufSize, GLubyte * pattern) {
  _glptr_glGetnPolygonStipple = (PFN_glGetnPolygonStipple)GalogenGetProcAddress("glGetnPolygonStipple");
   _glptr_glGetnPolygonStipple(bufSize, pattern);
}
PFN_glGetnPolygonStipple _glptr_glGetnPolygonStipple = _impl_glGetnPolygonStipple;

static void  GL_APIENTRY _impl_glGetnColorTable (GLenum target, GLenum format, GLenum type, GLsizei bufSize, void * table) {
  _glptr_glGetnColorTable = (PFN_glGetnColorTable)GalogenGetProcAddress("glGetnColorTable");
   _glptr_glGetnColorTable(target, format, type, bufSize, table);
}
PFN_glGetnColorTable _glptr_glGetnColorTable = _impl_glGetnColorTable;

static void  GL_APIENTRY _impl_glGetnSeparableFilter (GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, void * row, GLsizei columnBufSize, void * column, void * span) {
  _glptr_glGetnSeparableFilter = (PFN_glGetnSeparableFilter)GalogenGetProcAddress("glGetnSeparableFilter");
   _glptr_glGetnSeparableFilter(target, format, type, rowBufSize, row, columnBufSize, column, span);
}
PFN_glGetnSeparableFilter _glptr_glGetnSeparableFilter = _impl_glGetnSeparableFilter;

static void  GL_APIENTRY _impl_glGetnHistogram (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void * values) {
  _glptr_glGetnHistogram = (PFN_glGetnHistogram)GalogenGetProcAddress("glGetnHistogram");
   _glptr_glGetnHistogram(target, reset, format, type, bufSize, values);
}
PFN_glGetnHistogram _glptr_glGetnHistogram = _impl_glGetnHistogram;

static void  GL_APIENTRY _impl_glGetnMinmax (GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void * values) {
  _glptr_glGetnMinmax = (PFN_glGetnMinmax)GalogenGetProcAddress("glGetnMinmax");
   _glptr_glGetnMinmax(target, reset, format, type, bufSize, values);
}
PFN_glGetnMinmax _glptr_glGetnMinmax = _impl_glGetnMinmax;
