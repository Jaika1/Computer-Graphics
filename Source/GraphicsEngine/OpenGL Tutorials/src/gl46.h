...
typedef void  (GL_APIENTRY *PFN_glGetnConvolutionFilter)(GLenum target, GLenum format, GLenum type, GLsizei bufSize, void * image);
extern PFN_glGetnConvolutionFilter _glptr_glGetnConvolutionFilter;
#define glGetnConvolutionFilter _glptr_glGetnConvolutionFilter
...
typedef void  (GL_APIENTRY *PFN_glGetnMapfv)(GLenum target, GLenum query, GLsizei bufSize, GLfloat * v);
extern PFN_glGetnMapfv _glptr_glGetnMapfv;
#define glGetnMapfv _glptr_glGetnMapfv
...
typedef void  (GL_APIENTRY *PFN_glGetInternalformati64v)(GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint64 * params);
...
typedef void  (GL_APIENTRY *PFN_glGetnMapiv)(GLenum target, GLenum query, GLsizei bufSize, GLint * v);
extern PFN_glGetnMapiv _glptr_glGetnMapiv;
#define glGetnMapiv _glptr_glGetnMapiv
...
typedef void  (GL_APIENTRY *PFN_glGetnMapdv)(GLenum target, GLenum query, GLsizei bufSize, GLdouble * v);
extern PFN_glGetnMapdv _glptr_glGetnMapdv;
#define glGetnMapdv _glptr_glGetnMapdv

typedef void  (GL_APIENTRY *PFN_glGetnPixelMapfv)(GLenum map, GLsizei bufSize, GLfloat * values);
extern PFN_glGetnPixelMapfv _glptr_glGetnPixelMapfv;
#define glGetnPixelMapfv _glptr_glGetnPixelMapfv

typedef void  (GL_APIENTRY *PFN_glGetnPixelMapuiv)(GLenum map, GLsizei bufSize, GLuint * values);
extern PFN_glGetnPixelMapuiv _glptr_glGetnPixelMapuiv;
#define glGetnPixelMapuiv _glptr_glGetnPixelMapuiv

typedef void  (GL_APIENTRY *PFN_glGetnPixelMapusv)(GLenum map, GLsizei bufSize, GLushort * values);
extern PFN_glGetnPixelMapusv _glptr_glGetnPixelMapusv;
#define glGetnPixelMapusv _glptr_glGetnPixelMapusv

typedef void  (GL_APIENTRY *PFN_glGetnPolygonStipple)(GLsizei bufSize, GLubyte * pattern);
extern PFN_glGetnPolygonStipple _glptr_glGetnPolygonStipple;
#define glGetnPolygonStipple _glptr_glGetnPolygonStipple

typedef void  (GL_APIENTRY *PFN_glGetnColorTable)(GLenum target, GLenum format, GLenum type, GLsizei bufSize, void * table);
extern PFN_glGetnColorTable _glptr_glGetnColorTable;
#define glGetnColorTable _glptr_glGetnColorTable

typedef void  (GL_APIENTRY *PFN_glGetnSeparableFilter)(GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, void * row, GLsizei columnBufSize, void * column, void * span);
extern PFN_glGetnSeparableFilter _glptr_glGetnSeparableFilter;
#define glGetnSeparableFilter _glptr_glGetnSeparableFilter

typedef void  (GL_APIENTRY *PFN_glGetnHistogram)(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void * values);
extern PFN_glGetnHistogram _glptr_glGetnHistogram;
#define glGetnHistogram _glptr_glGetnHistogram

typedef void  (GL_APIENTRY *PFN_glGetnMinmax)(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, void * values);
extern PFN_glGetnMinmax _glptr_glGetnMinmax;
#define glGetnMinmax _glptr_glGetnMinmax
